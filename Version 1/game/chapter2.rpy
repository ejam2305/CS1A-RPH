...
label subChapter_1:
    ...
    scene bg town-square with fade
...
label sub_chapter3:
    ...
    scene bg militarybase-storageroom with fade
...
label textEvent3:
    ...
    scene bg militarybase-hallway with fade
    ...
    scene bg figueroa-office with fade
